    ...
    <div className="cover">
      <div className="cover-grid">
        <div className="cover-left">
          ...
          <p className="lede">
            Five decisions across the lifecycle of a single training engagement.
            Read each situation, pick how you'd respond, and we'll talk about it.
          </p>
        ...
        <div className="cover-right">
          <div className="cover-card">
            ...
            <ol className="howlist">
              <li>
                ...
                <div>
                  <strong>Read the situation.</strong> A short message
                  from a client, a colleague, or an SME.
                </div>
              </li>
              <li>
                <span className="howlist-num">02</span>
                <div>
                  <strong>Pick a response.</strong> Four are offered.
                  Choose the one closest to what you'd actually say.
                </div>
              </li>
              <li>
                <span className="howlist-num">03</span>
                <div>
                  <strong>See the feedback.</strong> A short note on
              ...
              <li>
                ...
                <div>
                  <strong>Discuss.</strong> Each scenario ends with a
                  prompt for the room.
                </div>
              </li>
            </ol>
          ...
          <div className="cover-foot mono small muted">
            // Calibrated for L&amp;D consultants, instructional designers,
            and performance-improvement practitioners.
          </div>
        </div>
      </div>
    </div>
        ...
        <section className="panel options-panel">
          <header className="panel-head">
            ...
            <p className="panel-summary">
              The most efficient answer isn't always the right one.
            </p>
          </header>
      ...
      <div className="feedback-grid">
        ...
        <section className="panel feedback-main">
          <header className="panel-head">
            ...
            <p className="panel-summary chosen-quote">"{yourChoice.text.replace(/^"|"$/g, "")}"</p>
          </header>
          ...
          <div className="all-options">
            ...
            <ul className="all-options-list">
              {scenario.options.map((opt) => {
                ...
                return (
                  <li key={opt.id} className={`all-option ${opt.id === picked ? "all-option-picked" : ""}`}>
                    <div className="all-option-head">
                      <span className="option-letter small-letter">{opt.id}</span>
                      <span
                        className="all-option-label mono"
                        style={{ color: m.swatch }}
                      >
                        {m.chipLabel}
                      </span>
                      {opt.id === picked && (
        ...
        {/* RIGHT — common core + facilitator question */}
        <aside className="panel feedback-side">
          ...
          <div className="phase-context-card">
            ...
            <div className="phase-context-body">
              <div className="phase-context-num mono">{String(scenario.phaseNumber).padStart(2, "0")} / 05</div>
              <div className="phase-context-name">{scenario.phase}</div>
              <p className="phase-context-blurb">
                {phaseBlurb(scenario.phase)}
              </p>
            </div>
          </div>
            ...
            {[
              ...
              <div className="bar-row" key={key}>
                ...
                <div className="bar-track">
                  <div
                    className="bar-fill"
                    style={{ width: `${(n / 5) * 100}%`, background: VERDICT_META[key].swatch }}
                  />
                </div>
        ...
        <aside className="panel summary-side">
          <div className="core-card">
            ...
            <p className="core-text">
              The point isn't whether participants chose A every time. The
              point is the <em>pull</em> they felt — toward efficiency,
              toward rigor, toward avoiding conflict — and what that pull
              tells them about how they show up with real clients.
            </p>
          </div>
          ...
          <div className="facilitator-card">
            ...
            <ul className="closing-list">
              <li>
                Which scenario felt easiest to answer? Which felt hardest?
                What does that tell you?
              </li>
              <li>
                Where did you reach for the order-taker move? What did it
                offer in the moment that the stronger move did not?
              </li>
              <li>
                Identify one of these five conversations you've had — or
                ducked — in the last 90 days.
              </li>
            </ul>
          </div>
  ...
  return (
    <div className="app">
      ...
      <TweaksPanel title="Tweaks">
        <TweakSection title="Facilitation">
          <TweakToggle
            label="Facilitator mode"
            description="Reveal verdict labels next to options before the participant chooses. Use during walk-throughs or rehearsal."
